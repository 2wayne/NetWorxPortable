...
user in an INI file next to NetWorxPortable.exe called NetWorxPortable.ini.
...
copy AppNamePortable.ini from this directory to NetWorxPortable.ini next to
NetWorxPortable.exe. The options in the INI file are as follows:
